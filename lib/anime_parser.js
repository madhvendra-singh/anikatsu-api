...
const BASE_URL = 'https://ww2.gogoanime.com.co/';
const BASE_URL2 = 'https://www3.gogoanimes.fi/';
const ajax_url = 'https://ajax.gogo-load.com/';
const anime_info_url = 'https://www3.gogoanimes.fi/category/';
...
const seasons_url = 'https://www3.gogoanimes.fi/sub-category/';

const Referer = 'https://www3.gogoanimes.fi/';
